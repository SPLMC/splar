...
public class FMGeneratorEngine{
	...
	//This attribute holds the instance of FMGeneratorEngine class, generated by 
	//the factory method getInstance(); 
	private static FMGeneratorEngine instance = null;
	...
	/**
	 * Factory method of FMGeneratorEngine class.
	 * @return instance - returns an instance of FMGeneratorEngine class.
	 */
	public static FMGeneratorEngine getInstance() {
		instance = new FMGeneratorEngine();
		return instance;
	}
